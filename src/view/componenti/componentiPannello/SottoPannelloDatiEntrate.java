...
public class SottoPannelloDatiEntrate {
	...
	private void initGUI() {
		try {
			JLabel label_1 = new LabelTestoPiccolo(ControlloreSpese.getSingleton().getMessaggio("thisyear"));
			label_1.setBounds(164, 66, 141, 14);
			labels[2] = label_1;

			JLabel label_2 = new LabelTestoPiccolo(ControlloreSpese.getSingleton().getMessaggio("lastmonth"));
			label_2.setBounds(16, 67, 136, 14);
			labels[1] = label_2;

			JLabel label_3 = new LabelTestoPiccolo(ControlloreSpese.getSingleton().getMessaggio("thismonth"));
